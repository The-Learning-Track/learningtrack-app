...
{
	public class PickClassTableSource : UITableViewSource {
		protected string[] tableItems;
		//Contructor for loading plot in instructor interface
		public PickClassViewController viewC { get; set; }
		//to access previous selected path
		public NSIndexPath previous { get; set; }
		string cellIdentifier = "PickClassTableCell";
		
		//Constructors
		public PickClassTableSource (string[] items, PickClassViewController viewController)
		{
